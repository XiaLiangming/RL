...
def train(device: torch.device,
          ...
          grad_clip: float = 1.0,
          history_path: str = "./history/dqn_double.csv",
          best_model_save_path: str = "./models/dqn_double_best.pth"):
        ...
        while not done:
            ...
            if step > warmup_steps:
                ...
                if step % train_steps == 0:
                    ...
                    with torch.no_grad():
                        # Double DQN
                        online_next_q_values = online_model(next_states)
                        next_actions = online_next_q_values.argmax(1, keepdim=True)
...
if __name__ == "__main__":
    frame_stacking = 4
    eval_epsilon = 0.05
    history_path = "./history/dqn_double.csv"
    best_model_save_path = "./models/dqn_double_best.pth"
    gif_save_path = "./gifs/dqn_double.gif"
    plot_save_path = "./plots/dqn_double.png"
